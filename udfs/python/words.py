...
key = bucket.get_key("ngrams/books/20120701/eng-all/dictionary_89609.txt")
...
"failure", "fake", "falsehood", "fight", "fighting", "folly", "fool", "foolish"
...
def significant_english_word_count(words_bag):
