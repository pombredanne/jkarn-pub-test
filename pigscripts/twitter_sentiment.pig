...
-- Split the text of each tweet into words (removing non-letter characters) and calculate a sentiment score

tweets_tokenized		=	FOREACH tweets 
							GENERATE TOKENIZE(REPLACE(LOWER(text), '[^a-z\\s]+', '')) AS words;
