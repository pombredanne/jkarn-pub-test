...
%default OUTPUT_PATH 's3n://my-output-bucket/$MORTAR_EMAIL_S3_ESCAPED/mortar-examples'

/**
 * User-Defined Functions (UDFs)
 */
REGISTER '../udfs/python/mortar-examples.py' USING streaming_python AS mortar-examples;
...
with_udf_output = FOREACH filtered 
                 GENERATE field0..field2, 
                          mortar-examples.example_udf(field0) AS example_udf_field;
